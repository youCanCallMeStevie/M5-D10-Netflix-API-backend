...
const { writeReviews, getReviews } = require("../../lib/utils");
...
// reviewsRouter.route("/").get(async (req, res, next) => {
//     try {
...
//   reviewsRouter.put("/:imdbID", movieValidation, async (req, res, next) => {
//     try {
...
//   reviewsRouter.post("/:imdbID/reviews/", reviewValidation, async (req, res, next) => {
//     try {
//       const books = await getMedia();
...
//   reviewsRouter.delete("/:asin/comments/:commentId", async (req, res, next) => {
//     try {
//       const books = await getMedia();
//       const bookIndex = books.findIndex(
//         book => book.asin === req.params.asin
...
//   reviewsRouter.delete("/:asin", async (req, res, next) => {
//     try {
//       const books = await getMedia();
...
//             ? {
//                 ...medium,
//                 Poster: `http://localhost:${process.env.PORT}/movies/${req.params.id}.${extention}`,
